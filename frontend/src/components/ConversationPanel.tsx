...
export function ConversationPanel({
  ...
  return (
    <div className="flex flex-col h-full bg-gray-800/30 rounded-lg">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
        <h3 className="text-sm font-medium text-white">대화 기록</h3>
        <span className="text-xs text-gray-500">{messages.length}개의 메시지</span>
      </div>
